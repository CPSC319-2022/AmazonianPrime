    ...
    <div className="product-details">
      ...
      <Grid container rowSpacing={0}>
        <Grid item xs={0.9} marginTop={0.2} marginBottom={0.2}>
          <div className="circle">{user.firstName.charAt(0)}{user.lastName.charAt(0)}</div>
        </Grid>
      ...
      <Grid container rowSpacing={0}>
        ...
        <div className="buttons">
          <Button variant="contained" color="secondary" sx={{paddingBottom: 0, paddingTop: 0, minWidth: 120, boxShadow: 0}}>
            Add to Cart
          </Button>
          <Button variant="contained" color="secondary" sx={{ml: 2, paddingBottom: 0, paddingTop: 0, minWidth: 120, boxShadow: 0}}>
            Buy Now
          </Button>
        </div>
      </Grid>
