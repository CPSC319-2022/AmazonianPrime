...
const AddressGrid: React.FC<AddressGridProps> = ({
  ...
  let newAddress: { StreetAddress: any; CityName: any; Province: any; PostalCode: any; Country: any; AddressID?: string | undefined; UserID?: string | undefined; IsBillingAddr?: boolean; IsShipAddr?: boolean; };
  ...
  return (
    <div className="address-grid">
      <Grid container spacing={1.5}>
        <Grid item xs={12}>
          <TextField fullWidth required label="Street Address" defaultValue="" variant="filled" onChange={handleStreetAddressInput} />
        </Grid>
        <Grid item xs={6}>
          <TextField fullWidth required label="City" defaultValue="" variant="filled" onChange={handleCityInput} />
        </Grid>
        <Grid item xs={6}>
          <TextField fullWidth required label="Province" defaultValue="" variant="filled" onChange={handleProvinceInput} />
        </Grid>
        <Grid item xs={6}>
          <TextField fullWidth required label="Postal Code" defaultValue="" variant="filled" onChange={handlePostalCodeInput} />
        </Grid>
        <Grid item xs={6}>
          <TextField fullWidth required label="Country" defaultValue="" variant="filled" onChange={handleCountryInput} />
        </Grid>
      </Grid>
    </div>
  );
