import { Button, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, TextField, Stack } from '@mui/material';
    ...
    return (
        ...
        <Dialog open={open} onClose={() => handleClose(false)}>
            ...
            <DialogActions style={{paddingRight: 25, paddingBottom: 20}}>
                ...
                <Button color="secondary" variant="contained" onClick={() => handleClose(false)}> Save </Button>
            </DialogActions>
        </Dialog>
        </div>
  );
