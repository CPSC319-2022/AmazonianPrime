...
exports.lambdaHandler = async (event, context) => {
  ...
  const addListingsQueries = [
    `INSERT INTO Listing (ListingID, UserID, ListingName, Description, Cost, Quantity, Category, ItemCondition, PostedTimestamp, IsActiveListing) VALUES (1, 1, "MCM Arm Chair", "Great condition.", 40.00, 2, "Amazon Merchandise", "Used- Like New", "2023-03-01 12:00:00", true)`,
